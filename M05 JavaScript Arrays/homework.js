...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabrascocatenadas = palabras.join(' ');
   return palabrascocatenadas;
}
...
function todosIguales(array) {
   ...
   for(let i =1; i < array.length ; i++){
      if(Iguales === array[i]){Iguales = array[i]
      } else return false 
   }return true;
